...
import { FileText, Download, Loader2, User as UserIcon, Globe } from "lucide-react";
...
function PortalDocumentenPage() {
  ...
  return (
    <PortalShell>
      <h1 className="font-display text-3xl font-bold">Documenten</h1>
      ...
      {loading ? (
        ...
        <>
          <DocSection
            ...
            subtitle="Persoonlijke documenten — alleen zichtbaar voor jou en de beheerders."
          ...
          <DocSection
            ...
            subtitle="Documenten die voor alle leden beschikbaar zijn."
            ...
            >
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-accent">
                  <FileText size={12} />
                  {new Date(d.created_at).toLocaleDateString("nl-NL", { dateStyle: "long" })}
                </div>
              ...
              <button
                ...
                className="inline-flex shrink-0 items-center gap-1.5 rounded-md bg-accent px-4 py-2 text-sm font-semibold text-accent-foreground hover:bg-[var(--accent-light)]"
              >
